...
The sultan himself led a larger expedition the following year, winning a pitched battle, but failed to capture any fortresses and withdrew when disease and hunger ravaged his army.`,
    ...
    },
    {
        ...
        actualYear: 1697,
        difficulty: "hard",
        description: `A major imperial army—perhaps 80,000 strong—attempted to cross a river at the end of a long campaign season. Their enemies, whom they believed to be in winter quarters, suddenly appeared with over 50,000 men equipped with flintlock muskets and disciplined cavalry.

The attacking general was among the finest commanders of the age, veteran of dozens of victories. He struck while the imperial army was half-across the river, its forces divided and unable to support each other.

The troops still on the near bank were annihilated. The slave-soldier infantry fought desperately but were overwhelmed; perhaps 20,000 were killed outright and another 10,000 drowned attempting to flee across the river. The grand vizier died in the chaos, killed by his own mutinous soldiers. The imperial treasury, the royal harem, and the state seal were all captured. The sultan himself, who had already crossed, fled with only what horses could carry.

The disaster forced the empire to accept peace, ending a war that had begun with an attempt to capture the enemy capital fourteen years earlier.`,
        hints: [
            { cost: 20, text: "Large eastern imperial armies with slave-soldier infantry and feudal cavalry caught crossing a river by European forces with flintlock muskets—'half-across the river, its forces divided and unable to support each other'—characterized the turning point when Ottoman expansion into Europe was permanently reversed.", explanation: "The military composition helps date this battle." },
