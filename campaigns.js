...
When the imperial cavalry shattered the northern left wing, the day seemed lost. But the king's disciplined infantry wheeled to face the threat while he personally led cavalry charges to stabilize the line. By evening, the imperial army had been annihilated—nearly 13,000 dead on the field.`,
        ...
        explanation: "This was the Battle of Breitenfeld in 1631, during the Thirty Years' War. King Gustavus Adolphus of Sweden—the 'Lion of the North'—defeated the Catholic Imperial army under Count Tilly. Gustavus revolutionized warfare: shallower formations (6 ranks vs 30), mobile artillery, cavalry charging with swords instead of caracoling with pistols. Tilly lost 13,000 dead and his reputation for invincibility. Gustavus died the next year at Lützen but changed warfare forever. For dating: matchlock muskets were standard 1500-1700 (flintlocks replaced them). Partial armor (breastplate and helmet only) indicates post-1550 when full plate became impractical. No bayonets indicates pre-1670. The tercio's defeat by linear formations marks the 1630s-1640s transition.",
...
The war ended in negotiated access for pilgrims—a pale shadow of original ambitions.`,
        ...
        explanation: "This was the Third Crusade (1189-1192). Richard I 'the Lionheart' of England and Philip II of France led the crusade after Saladin captured Jerusalem in 1187. Emperor Frederick Barbarossa drowned crossing a river in Anatolia. Richard besieged Acre for two years, massacred 2,700 prisoners when Saladin delayed ransom, and defeated Saladin at Arsuf—but never took Jerusalem. He famously refused to even look at the city he couldn't capture. For dating: chain mail hauberks without plate armor indicates pre-1300 (plate appeared late 13th century and dominated by 1400). Crossbows as the dominant missile weapon places this 1100-1400 (before firearms, after javelins).",
...
The ensuing battle was a disaster. The exhausted, outnumbered invaders attacked across swampy ground and were destroyed. The king escaped with a handful of followers but would never recover his former power. His kingdom would slowly be dismembered by the enemies he had once humiliated.`,
        ...
        explanation: "This was the Battle of Poltava (1709) in the Great Northern War. King Charles XII of Sweden—considered the greatest soldier of his age—invaded Russia with 40,000 men but was destroyed by Tsar Peter the Great's scorched-earth tactics and the brutal winter of 1708-09 (the coldest in 500 years). Charles, wounded and carried on a litter, attacked with 20,000 survivors against 45,000 Russians. The Swedes were annihilated; Charles fled to Ottoman territory. Sweden never recovered; Peter built St. Petersburg and modernized Russia. For dating: socket bayonets replaced pikes between 1690-1710—'recently replaced' indicates the early 18th century. Flintlock muskets in linear formations were standard 1700-1850.",
...
The defeated power, shocked by the scale of their losses, signed a neutrality pact that would hold for nearly two years. The victorious commander's reputation soared, and he would soon face a far greater test. The lessons of this battle—particularly the effectiveness of combined arms and deep operations—would prove prophetic.`,
        ...
        explanation: "This was the Battle of Khalkhin Gol (Nomonhan) in 1939—a massive undeclared war between the Soviet Union and Japan on the Mongolian-Manchurian border. General Georgy Zhukov commanded Soviet forces, using combined-arms tactics that presaged his WWII victories. Japan suffered 18,000+ casualties and signed a neutrality pact in April 1941—freeing Stalin to focus on Germany and convincing Japan to expand south toward US/British colonies rather than north. For dating: light tanks dominated 1930-1940; medium tanks with heavier armor became standard during WWII. Mixed biplane/monoplane air forces indicate the brief 1935-1940 transition. The neutrality pact lasting 'nearly two years' (ended August 1945) confirms 1939.",
