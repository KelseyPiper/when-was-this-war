...
The final assault came through a gate left unlocked in the confusion of battle. The emperor died fighting in the breach, his body never identified among the fallen.`,
        ...
        explanation: "This was the Fall of Constantinople in 1453. Massive bombards requiring on-site casting were only used from about 1420-1480, before smaller bronze cannon on wheeled carriages made them obsolete. Defenders using crossbows rather than handguns indicates pre-1500 (arquebuses replaced crossbows by 1550). The 'thousand-year empire' with an emperor dying in battle matches only the Byzantine Empire's fall.",
...
When the imperial cavalry shattered the northern left wing, the day seemed lost. But the king's disciplined infantry wheeled to face the threat while he personally led cavalry charges to stabilize the line. By evening, the imperial army had been annihilated—nearly 13,000 dead on the field.`,
        ...
        explanation: "This was the Battle of Breitenfeld in 1631, during the Thirty Years' War. Matchlock muskets were standard 1500-1700 (flintlocks replaced them afterward). Partial armor (breastplates and helmets only) indicates post-1550 when full plate became impractical against firearms. The absence of bayonets indicates pre-1670 when socket bayonets appeared. Tercio squares dominated 1530s-1640s; their defeat by linear formations marks this as the 1630s transition.",
...
The siege demonstrated the increasing lethality of defensive warfare and the need for new tactical approaches. The lessons would be studied carefully in military academies—though many commanders would ignore them until forced to relearn them through bitter experience decades later.`,
        ...
        explanation: "This was the Siege of Plevna (1877) in the Russo-Turkish War. Single-shot breech-loading rifles were standard from 1860-1890—muzzle-loaders required standing to reload (pre-1860), while magazine rifles (post-1890) held multiple rounds. Army sizes of 185,000 became possible only with railroad logistics (post-1860). Telegraph coordination of armies was new in the 1860s. These technologies together indicate the 1870s-1880s.",
...
The captured king would spend a year as a prisoner before being ransomed for an enormous sum and territorial concessions. The balance of power had shifted decisively.`,
        ...
        explanation: "This was the Battle of Pavia in 1525. Heavy arquebuses requiring forked rests were used from 1500-1550; lighter models appeared mid-century. The 3:1 pike-to-shot ratio was typical of the early 1500s—by 1600 it was 1:1, by 1700 pikes were gone entirely. Knights still wearing full armor and charging en masse indicates before 1550, when firearms made such tactics suicidal.",
...
The war ended in negotiated access for pilgrims—a pale shadow of original ambitions.`,
        ...
        explanation: "This was the Third Crusade (1189-1192). Chain mail hauberks without plate armor indicates pre-1300. Crossbows as the dominant missile weapon (rather than later firearms or earlier javelins) places this 1100-1400. The two-year siege of a port city, a king drowning on the journey, and massacred prisoners during ransom negotiations all match the specific events of Richard I's crusade.",
...
The victory transformed the continental balance of power and set the stage for unification of many smaller states under northern leadership within a few years.`,
        ...
        explanation: "This was the Austro-Prussian War of 1866. The Dreyse needle gun (first widely-adopted bolt-action rifle) was in service 1848-1871. The decisive advantage of breech-loaders over muzzle-loaders was demonstrated in the 1860s wars. Railroad mobilization for strategic concentration was revolutionary in the 1860s—earlier wars couldn't move armies this way. Together these indicate the 1860s.",
...
The armies who faced them—feudal knights from across the region—never developed effective counter-tactics. Eventually, the rebels fell to fighting among themselves over theological differences. A moderate faction made peace with the church, and together they destroyed the radicals.`,
        ...
        explanation: "These were the Hussite Wars (1419-1434). Hook-guns (heavy early handguns) were used from about 1380-1480. Their rough parity with crossbows indicates the early 15th century—firearms only appeared in Europe around 1350, and crossbows remained competitive until about 1500 when arquebuses became clearly superior. War wagons as mobile fortifications were systematized by the Hussites in this specific conflict.",
...
The ensuing battle was a disaster. The exhausted, outnumbered invaders attacked across swampy ground and were destroyed. The king escaped with a handful of followers but would never recover his former power. His kingdom would slowly be dismembered by the enemies he had once humiliated.`,
        ...
        explanation: "This was the Great Northern War, specifically the Battle of Poltava (1709). Socket bayonets replaced pikes in most European armies between 1690-1710—'recently replaced' indicates the early 18th century specifically. Flintlock muskets with bayonets in linear formations were standard 1700-1850. The 'coldest winter in a century' refers to the Great Frost of 1709, the coldest European winter in 500 years.",
...
The campaign was a strategic failure. Despite suffering fewer casualties, the invaders abandoned the offensive and withdrew. The opportunity to capture the rebel capital had been squandered. The war would grind on for several more years at a cost of hundreds of thousands of lives.`,
        ...
        explanation: "This was the Peninsula Campaign of 1862 during the American Civil War. Rifled muskets accurate to 500 yards replaced smoothbores (100 yards) in the 1850s. Observation balloons were first used militarily in the 1860s. Ironclads first saw combat in 1862—earlier navies were wooden, later navies used steel. These three technologies converging indicates precisely the early 1860s.",
...
The defeated power, shocked by the scale of their losses, signed a neutrality pact that would hold for nearly two years. The victorious commander's reputation soared, and he would soon face a far greater test. The lessons of this battle—particularly the effectiveness of combined arms and deep operations—would prove prophetic.`,
        ...
        explanation: "This was the Battle of Khalkhin Gol (1939). Light tanks dominated armored forces 1930-1940; medium tanks with heavier armor became standard during WWII (1939-1945). Military aviation transitioned from biplanes to monoplanes between 1935-1940—mixed biplane/monoplane forces indicate this brief transition window. The neutrality pact lasting 'nearly two years' (the Soviet-Japanese Neutrality Pact ended August 1945) confirms 1939.",
...
The empire's treasures were seized and sent home. A new colonial society emerged that would endure for three centuries.`,
        ...
        explanation: "This was the Spanish Conquest of the Aztec Empire (1519-1521). Matchlock arquebuses were standard portable firearms 1475-1650. Steel weapons, horses, and firearms against peoples without iron-working or cavalry occurred during the Age of Exploration (1490-1550). The 'three centuries' of colonial rule ending places independence around 1820 (Mexican independence was 1821), pointing back to conquest around 1520.",
